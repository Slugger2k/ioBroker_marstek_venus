...
describe('RateLimitQueue', function() {
    ...
    describe('integration - multiple tasks', () => {
        it('executes tasks sequentially with rate limiting', async () => {
            ...
            const results = [];
            const task1 = () => { results.push(1); return Promise.resolve(1); };
            const task2 = () => { results.push(2); return Promise.resolve(2); };
            const task3 = () => { results.push(3); return Promise.resolve(3); };
